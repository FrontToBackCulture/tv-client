  ...
  return useQuery({
    ...
    queryFn: async (): Promise<WorkspaceWithDetails | null> => {
      ...
      return {
        ...
        deal_mrr: (project as any).deal_mrr ?? null,
        deal_setup_fee: (project as any).deal_setup_fee ?? null,
        deal_arr: (project as any).deal_arr ?? null,
        deal_year_1_total: (project as any).deal_year_1_total ?? null,
