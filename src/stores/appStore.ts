...
export type ModuleId = "home" | "library" | "projects" | "metadata" | "work" | "inbox" | "calendar" | "crm" | "domains" | "product" | "gallery" | "bot" | "skills" | "portal" | "scheduler" | "repos" | "email" | "blog" | "s3browser";
export type Theme = "light" | "dark";
export type SettingsView = "keys" | "val" | "sync" | "mcp" | "claude" | "bots" | "notion" | null;

const VALID_MODULES: ModuleId[] = ["home", "library", "projects", "metadata", "work", "inbox", "calendar", "crm", "domains", "product", "gallery", "bot", "skills", "portal", "scheduler", "repos", "email", "blog", "s3browser"];
