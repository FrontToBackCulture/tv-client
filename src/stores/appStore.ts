...
const VALID_MODULES = ["home", "library", "projects", "metadata", "work", "inbox", "calendar", "chat", "crm", "domains", "analytics", "product", "gallery", "skills", "mcp-tools", "portal", "scheduler", "repos", "email", "blog", "guides", "documentation", "s3browser", "prospecting", "public-data", "referrals", "investment", "finance", "shared-inbox", "settings"] as const;
