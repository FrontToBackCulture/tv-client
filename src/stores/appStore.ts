...
export type ModuleId = "home" | "library" | "projects" | "metadata" | "work" | "workspace" | "inbox" | "crm" | "domains" | "product" | "gallery" | "bot" | "skills" | "questions" | "portal" | "scheduler" | "repos" | "email";
export type Theme = "light" | "dark";
export type SettingsView = "keys" | "val" | "sync" | "mcp" | "claude" | "bots" | "notion" | null;

const VALID_MODULES: ModuleId[] = ["home", "library", "projects", "metadata", "work", "workspace", "inbox", "crm", "domains", "product", "gallery", "bot", "skills", "questions", "portal", "scheduler", "repos", "email"];
