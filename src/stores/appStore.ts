...
export type ModuleId = "library" | "work" | "workspace" | "inbox" | "crm" | "product" | "gallery" | "bot" | "skills" | "portal" | "scheduler" | "repos" | "email";
export type Theme = "light" | "dark";
export type SettingsView = "keys" | "val" | "sync" | "mcp" | "claude" | "bots" | null;

const VALID_MODULES: ModuleId[] = ["library", "work", "workspace", "inbox", "crm", "product", "gallery", "bot", "skills", "portal", "scheduler", "repos", "email"];
