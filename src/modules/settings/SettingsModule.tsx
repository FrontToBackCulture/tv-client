...
import { usePortalSites, useCreateSite, useUpdateSite, useDeleteSite } from "../../hooks/usePortal";
...
const FEATURE_CONFIG = [
  { key: "chat", label: "Chat", desc: "Live chat with customers", icon: "💬" },
  { key: "help_center", label: "Help Center", desc: "Knowledge base articles", icon: "📖" },
  { key: "sitemap", label: "My Resources", desc: "Dashboards, workflows, tables", icon: "🗂️" },
  { key: "changelog", label: "Changelog", desc: "What's New updates", icon: "📢" },
  { key: "banners", label: "Banners", desc: "Top-bar announcements", icon: "🔔" },
  { key: "popups", label: "Popups", desc: "Modal announcements", icon: "💡" },
...
function PortalSiteCard({ site }: { site: PortalSite }) {
  ...
  return (
    <div className="border border-slate-200 dark:border-zinc-800 rounded-lg overflow-hidden">
      ...
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        className="w-full flex items-center justify-between px-4 py-3 hover:bg-slate-50 dark:hover:bg-zinc-900/50 transition-colors text-left"
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono text-zinc-400 bg-slate-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded flex-shrink-0">
                {site.slug}
              </span>
            </div>
            {site.base_url && (
      ...
      {isExpanded && (
        <div className="border-t border-slate-200 dark:border-zinc-800">
          {/* Site details */}
          <div className="px-4 py-3 bg-slate-50/50 dark:bg-zinc-900/30">
                ...
                <div className="grid grid-cols-[1fr_140px] gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2.5 py-1.5 text-sm border border-slate-300 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100"
                      autoFocus
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      placeholder="slug"
                      className="w-full px-2.5 py-1.5 text-sm border border-slate-300 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 font-mono"
                    />
                  </div>
                </div>
                <div>
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="text-zinc-900 dark:text-zinc-100 font-mono text-xs truncate">
                    {site.base_url || <span className="text-zinc-300 dark:text-zinc-600">—</span>}
                  </div>
                </div>
              </div>
            )}
...
function PortalSettingsView() {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="grid grid-cols-[1fr_160px] gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-slate-300 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100"
                  autoFocus
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="my-company"
                  className="w-full px-3 py-2 text-sm border border-slate-300 dark:border-zinc-700 rounded-md bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 font-mono"
                />
              </div>
            </div>
            <div>
      ...
      {/* Info box at bottom */}
      {sites && sites.length > 0 && (
        <div className="p-3.5 bg-slate-50 dark:bg-zinc-900/50 border border-slate-200 dark:border-zinc-800 rounded-lg">
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            Each site gets its own widget via <code className="text-[11px] bg-slate-100 dark:bg-zinc-800 px-1 py-0.5 rounded">?site=slug</code>.
