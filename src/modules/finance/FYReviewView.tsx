...
function buildGrid(
  ...
  for (const [fsLine, label] of Object.entries(FS_LINE_LABELS) as Array<[string, string]>) {
    if (!meta.has(fsLine)) {
...
// FS-line display labels + section ordering extracted to fsLineLabels.ts and
// shared with the Expense Review tab — both views need identical P&L
// nomenclature for grouping consistency.
