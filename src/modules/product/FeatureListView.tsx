...
import { useProductFeatures, useProductModules } from "../../hooks/useProduct";
        ...
        return (
          <div key={group.module.id}>
            <button
              ...
              className="w-full flex items-center gap-2 px-4 py-2 text-left bg-slate-100 dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 hover:bg-slate-200 dark:hover:bg-zinc-800 transition-colors"
            >
            ...
            {!isCollapsed && group.features.map((feature) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center justify-between px-4 py-2.5 text-left border-b border-slate-100 dark:border-zinc-800/50 transition-colors",
