  ...
  return (
    <div className="h-full flex items-center justify-center bg-slate-50 dark:bg-zinc-950">
      <div className="text-center">
        <Settings size={48} className="mx-auto mb-4 text-zinc-400 dark:text-zinc-700" />
        <h2 className="text-xl font-semibold text-zinc-600 dark:text-zinc-400">Console</h2>
