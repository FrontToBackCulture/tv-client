...
function ToggleSwitch({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "absolute top-0.5 w-4 h-4 rounded-full bg-white dark:bg-zinc-200 transition-transform shadow-sm",
...
function SiteTargeting({
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-md shadow-lg z-20 py-1">
          {sites.map((site) => (
            <button
              key={site.id}
