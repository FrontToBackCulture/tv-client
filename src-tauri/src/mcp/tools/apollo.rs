...
use crate::commands::apollo::api::ApolloClient;
use crate::commands::apollo::types::ApolloSearchFilters;
...
fn build_search_summary(response: &crate::commands::apollo::types::ApolloSearchResponse) -> String {
    use std::fmt::Write;
